"""Stage 1: ingest a raw chapter and write work/<chapter>.segments.jsonl.
...
def main() -> None:
    ...
    parser.add_argument("source", help="raw source file, e.g. source/ch012.txt")
    ...
    out_path = root / "work" / f"{chapter}.segments.jsonl"
