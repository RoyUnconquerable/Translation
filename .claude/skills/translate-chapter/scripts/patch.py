...
mechanical fixes (casing, punctuation, quote marks, banned glyphs) - so
that applying them does not cost a subagent spawn. Anything requiring
translation judgment still goes through chapter-drafter Mode B.
...
def main() -> None:
    ...
    draft_path = root / "work" / f"{args.chapter}.draft.jsonl"
