...
This is the exemplar bank for the style guide. Each entry gives a gloss of the
Chinese, a stiff draft line, the repaired line, and the mechanism that made the
difference. The number in each heading is the style guide section it shows.

Examples show a principle. They are not sentence templates; do not copy their
